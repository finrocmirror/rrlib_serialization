...
#ifndef __rrlib__serialization__tGenericObjectBaseImpl_h__
#define __rrlib__serialization__tGenericObjectBaseImpl_h__
...
public:
  ...
  tGenericObjectBaseImpl() : tGenericObject(tDataType<T>()) {}
...
#endif // __rrlib__serialization__tGenericObjectBaseImpl_h__
