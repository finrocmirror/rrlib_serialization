...
template <typename T>
inline typename std::enable_if < IsSerializableMap<T>::value && IsBinarySerializable<typename IsSerializableMap<T>::tKey>::value && IsBinarySerializable<typename IsSerializableMap<T>::tMapped>::value, tOutputStream >::type&
